            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        path: '/administration',
                        items: [
                            { label: 'Gestion rôles', icon: 'pi pi-shield', routerLink: ['/administration/roles'] },
                            { label: 'Gestion utilisateurs', icon: 'pi pi-users', routerLink: ['/administration/users'] },
                            { label: 'Traçabilité', icon: 'pi pi-list', routerLink: ['/administration/tracabilite'] }
                        ]
                    },
                    {
                        label: 'Auth',
