...
function Panel_div_0_p_button_6_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r2.headerIconsTemplate || ctx_r2._headerIconsTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(3, _c8, ctx_r2.collapsed));
  }
}
function Panel_div_0_p_button_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("text", true)("rounded", true)("styleClass", ctx_r2.cx("pcToggleButton"))("buttonProps", ctx_r2.toggleButtonProps)("pt", ctx_r2.ptm("pcToggleButton"))("unstyled", ctx_r2.unstyled());
...
function Panel_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("id", ctx_r2.id + "-titlebar")("data-p", ctx_r2.dataP);
    ɵɵadvance();
